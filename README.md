...
Читает Redis Streams, которые Remnawave 3.1 публикует при
...
`@remnawave/backend-contract@3.1.1`, `models/export-stream/export-stream.schema.ts`
...
в `subscription-requests.processor.ts`, живая и в 3.1.0. Парсер читает оба
